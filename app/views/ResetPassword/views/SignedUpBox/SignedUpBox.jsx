...
var SuStep1 = React.createClass({
  ...
  getCaptcha: function(e) {
    ...
    reqwest({
      url: "/service/mobile_sms?type=USER_RESET_PASSWORD",
      type: "json",
      method: "POST",
      data: {mobile: this.state.mp, csrf_token: getCookie("csrf_token")},
    ...
    return (
      <div className="result-box">
        ...
        <div className="return">
          <div className="r">
            系统将在{this.state.second}秒后自动跳转到登录页面
          </div>
